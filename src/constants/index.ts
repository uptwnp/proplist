...
// Enhanced Property Type Icons (using Lucide React icon names)
...
export const API_CONFIG = {
  baseUrl: 'https://prop.digiheadway.in/api/v3/listing/index.php',
  tables: {
...
export const ERROR_MESSAGES = {
  ...
  geocodingError: 'Unable to find location. Please try a different search term.',
} as const;
