...
export const PRICE_RANGES = [
  [0, 50], // 0 - 50 Lakhs
  [40, 70], // 40 - 70 Lakhs
  [70, 100], // 70 Lakhs - 1 Crore
  [90, 120], // 90 Lakhs - 1.2 Crore
  [110, 150], // 1.1 Cr - 1.5 Cr
  [140, 190], // 1.4 Cr - 1.9 Cr
  [180, 220], // 1.8 Cr - 2.2 Cr
  [200, 250], // 2 Cr - 2.5 Cr
  [230, 300], // 2.3 Cr - 3 Cr
  [280, 350], // 2.8 Cr - 3.5 Cr
  [320, 400], // 3.2 Cr - 4 Cr
  [370, 500], // 3.7 Cr - 5 Cr
  [450, 600], // 4.5 Cr - 6 Cr
  [550, 800], // 5.5 Cr - 8 Cr
  [800, 1500], // 8 Cr - 15 Cr
  [1500, 10000], // 15 Cr - 100 Cr
  [10000, 100000], // 100 Cr+
] as const;
...
export const SIZE_RANGES = [
  ...
  [70, 100], // 70 - 100 sq.yd
  [90, 120], // 90 - 120 sq.yd
  [110, 150], // 110 - 150 sq.yd
  [140, 190], // 140 - 190 sq.yd
  [180, 220], // 180 - 220 sq.yd
  [200, 250], // 200 - 250 sq.yd
  [230, 300], // 230 - 300 sq.yd
  [280, 350], // 280 - 350 sq.yd
  [320, 400], // 320 - 400 sq.yd
  [370, 500], // 370 - 500 sq.yd
  [450, 600], // 450 - 600 sq.yd
  [550, 800], // 550 - 800 sq.yd
  [800, 1500], // 800 - 1500 sq.yd
  [1500, 10000], // 1500 - 10000 sq.yd
  [10000, 100000], // 10000+ sq.yd
] as const;
